var basePath='http://corporatehealth-test.apigee.net/v1';
/*!
 * 
...
var App = angular.module('angle', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils'])
          .run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
              ...
              $rootScope.logoutUser = function() {
            	  ...
            	  $rootScope.$storage.removeItem('userInfo');
...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
	...
	.state('app.mygoals',
	{
		url : '/mygoals',
		templateUrl :  helper
		.basepath('mygoals.html'),
		controller : 'mygoalsController',
		resolve: helper.resolveFor('classyloader','bootstrap-js')
	})	
	
		.state('app.selectgoals',
	{
		url : '/selectgoals',
		templateUrl :  helper
		.basepath('selectgoal.html'),
		controller : 'selectgoalsController',
...
Fileinput.prototype.change = function(e) {
  ...
  if (this.$preview.length > 0 && (typeof file.type !== "undefined" ? file.type.match(/^image\/(gif|png|jpeg)$/) : file.name.match(/\.(gif|png|jpe?g)$/i)) && typeof FileReader !== "undefined") {
    ...
    reader.onload = function(re) {
      var $img = $('<img class="img-circle thumb96">')
